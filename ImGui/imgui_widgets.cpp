...
bool ImGui::tab(const char* label, bool selected)
{
    ...
    int a = int(t * 255);
    auto text_color = ImGui::GetColorU32(ImLerp(ImVec4(180 / 255.f, 180 / 255.f, 180 / 255.f, 180 / 255.f), ImVec4(182 / 255.f, 0 / 255.f, 182 / 255.f, 255.f / 255.f), t));
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (*v)
    {
        window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + pad, check_bb.Min.y + pad), ImVec2(check_bb.Max.x - pad, check_bb.Max.y - pad), ImColor(182, 0, 182, int(t * 205)), 2);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 9), ImVec2(grab_bb.Max.x, grab_bb.Max.y - 3 - 8), ImColor(182, 0, 182, 255), style.GrabRounding);
