...
namespace ImGui
{
    ...
    inline bool FocusableItemRegister(ImGuiWindow* window, ImGuiID id, bool tab_stop) { IM_ASSERT(0); IM_UNUSED(window); IM_UNUSED(id); return false; } // -> pass ImGuiItemAddFlags_Focusable flag to ItemAdd()
